...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/public/css/jquery.fancybox.min.css')}}">
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <div class="ftco-blocks-cover-1">
      <div class="site-section-cover overlay" style="background-image: url('assets/public/images/hero_1.jpg')">
        <div class="container">
    ...
    {{-- <div class="site-section">
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-md-4">
            <img src="assets/public/images/about_1.jpg" alt="Image" class="img-fluid">
          </div>
          <div class="col-md-4">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6">
            ...
            <div>
              <div class="person-pic-39219 mb-4">
                <img src="assets/public/images/person_1.jpg" alt="Image" class="img-fluid">
              </div>  
          ...
          <div class="col-lg-4 col-md-6">
            ...
            <div>
              <div class="person-pic-39219 mb-4">
                <img src="assets/public/images/person_2.jpg" alt="Image" class="img-fluid">
              </div>  
              <blockquote class="quote_39823">
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptas excepturi accusantium non aut perspiciatis nisi magni libero, molestias.</p>
              </blockquote>
          ...
          <div class="col-lg-4 col-md-6">
            ...
            <div>
              <div class="person-pic-39219 mb-4">
                <img src="assets/public/images/person_3.jpg" alt="Image" class="img-fluid">
              </div>  
              <blockquote class="quote_39823">
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptas excepturi accusantium non aut perspiciatis nisi magni libero, molestias.</p>
              </blockquote>
    ...
    <script src="{{ asset('assets/public/js/jquery-migrate-3.0.0.js')}}"></script>
    ...
    <script src="{{ asset('assets/public/js/jquery.animateNumber.min.js')}}"></script>
    <script src="{{ asset('assets/public/js/jquery.fancybox.min.js')}}"></script>
    ...
    <script src="{{ asset('assets/public/js/isotope.pkgd.min.js')}}"></script>
